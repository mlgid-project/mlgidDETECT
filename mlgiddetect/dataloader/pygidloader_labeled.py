...
def _load_fittedpeaks(f, key: str, frame_nr: int, data_loader: 'PyGIDDataset') -> Labels:
    """Read GT peaks from data/analysis/frameXXXXX/fittedpeaks and return a populated Labels object.
    ...
    Returns:
        Labels with .boxes (N x 4, polar pixel coords), .confidences, and .is_ring populated.
    """
    labels = Labels()
    ...
    confidences = peaks['score'].astype(np.float32)
